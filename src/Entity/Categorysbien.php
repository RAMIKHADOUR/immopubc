...
class Categorysbien
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Propertys::class, mappedBy: 'categorybien')]
    ...
    public function removeProperty(Propertys $property): static
    {
        if ($this->propertys->removeElement($property)) {
            ...
            if ($property->getCategorybien() === $this) {
                $property->setCategorybien(null);
            }
        }
